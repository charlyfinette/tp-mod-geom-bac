...
void MainWindow::on_pushButton_visualisation_clicked()
{
    // initialisation des couleurs et épaisseurs (sommets et arêtes) du mesh
    resetAllColorsAndThickness(&mesh);
...
void MainWindow::on_courbures_H_approx_clicked()
{
    mesh.update_normals();
    ...
    courb.compute_KH_approx();
    courb.set_H_colors();
    displayMesh(&mesh,DisplayMode::VertexColorShading);
}
void MainWindow::on_courbures_K_approx_clicked()
{
    mesh.update_normals();
    mesh.request_vertex_colors() ;
...
void MainWindow::on_courbures_H_clicked()
{
    mesh.update_normals();
    mesh.request_vertex_colors() ;
...
void MainWindow::on_courbures_K_clicked()
{
    mesh.update_normals();
    mesh.request_vertex_colors() ;
...
void MainWindow::showSelections(MyMesh* _mesh)
{
    ...
    auto v_it = _mesh->vertices_begin();
    auto vh   = *v_it ;
    int r = 0, g = 255, b = 0 ;
    OpenMesh::Vec3uc tmp_color = OpenMesh::Vec3uc(r,g,b) ;

    _mesh->set_color(vh , MyMesh::Color(tmp_color)) ;
...
void MainWindow::showSelectionsNeighborhood(MyMesh* _mesh)
{
    ...
    {
        _mesh->set_color(*vv_it , MyMesh::Color(tmp_color)) ;
    }
...
void MainWindow::resetAllColorsAndThickness(MyMesh* _mesh)
{
    for (MyMesh::VertexIter curVert = _mesh->vertices_begin(); curVert != _mesh->vertices_end(); curVert++)
    {
        ...
        _mesh->set_color(*curVert, MyMesh::Color(250, 250, 250));
    }
